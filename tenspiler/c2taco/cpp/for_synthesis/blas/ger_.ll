; ModuleID = 'for_synthesis/blas/ger_.ll'
source_filename = "for_synthesis/blas/ger_.cc"
...
define dso_local void @_Z3geriiNSt3__16vectorIiNS_9allocatorIiEEEES3_NS0_IS3_NS1_IS3_EEEE(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %M, i32 %N, %"class.std::__1::vector.0"* %x, %"class.std::__1::vector.0"* %y, %"class.std::__1::vector"* %A) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
bb17:                                             ; preds = %for.cond1
  br label %for.end

bb18:                                             ; preds = %for.end13
  br label %nrvo.skipdtor

bb19:                                             ; preds = %for.end13
