; ModuleID = 'for_synthesis/mathfu/lerp_.ll'
source_filename = "for_synthesis/mathfu/lerp_.cc"
...
define dso_local void @_Z4lerpiNSt3__16vectorIiNS_9allocatorIiEEEES3_i(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %N, %"class.std::__1::vector"* %a, %"class.std::__1::vector"* %b, i32 %t) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body:                                         ; preds = %bb
  %i4 = load i32, i32* %t.addr, align 4
  ...
  %i7 = load i32, i32* %t.addr, align 4
  %sub = sub nsw i32 1, %i7
  %i8 = load i32, i32* %i, align 4
  %conv1 = sext i32 %i8 to i64
  ...
  %i9 = load i32, i32* %call2, align 4
  %mul3 = mul nsw i32 %sub, %i9
  %add = add nsw i32 %mul, %mul3
  store i32 %add, i32* %interp, align 4
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector"* %agg.result, i32* nonnull align 4 dereferenceable(4) %interp)
...
for.end:                                          ; preds = %bb11
  ...
  br i1 %nrvo.val, label %bb12, label %bb13

nrvo.unused:                                      ; preds = %bb13
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector"* %agg.result) #10
  br label %nrvo.skipdtor

nrvo.skipdtor:                                    ; preds = %bb12, %nrvo.unused
  ret void
