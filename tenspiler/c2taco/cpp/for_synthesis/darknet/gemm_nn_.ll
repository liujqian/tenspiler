; ModuleID = 'for_synthesis/darknet/gemm_nn_.ll'
source_filename = "for_synthesis/darknet/gemm_nn_.cc"
...
define dso_local void @_Z7gemm_nniiiiNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_S5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %ALPHA, i32 %M, i32 %N, i32 %K, %"class.std::__1::vector"* %A, %"class.std::__1::vector"* %B, %"class.std::__1::vector"* %C) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
