; ModuleID = 'for_synthesis/darknet/gemm_tt_.ll'
source_filename = "for_synthesis/darknet/gemm_tt_.cc"
...
define dso_local void @_Z7gemm_ttiiiiNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_S5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %ALPHA, i32 %M, i32 %N, i32 %K, %"class.std::__1::vector"* %A, %"class.std::__1::vector"* %B, %"class.std::__1::vector"* %C) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond1:                                        ; preds = %for.inc19, %invoke.cont
  %i5 = load i32, i32* %j, align 4
  %i6 = load i32, i32* %N.addr, align 4
  %cmp2 = icmp slt i32 %i5, %i6
  br i1 %cmp2, label %bb24, label %bb25

for.body3:                                        ; preds = %bb24
  store i32 0, i32* %sum, align 4
  store i32 0, i32* %k, align 4
  br label %for.cond4

for.cond4:                                        ; preds = %for.inc, %for.body3
  %i7 = load i32, i32* %k, align 4
  %i8 = load i32, i32* %K.addr, align 4
  %cmp5 = icmp slt i32 %i7, %i8
  br i1 %cmp5, label %bb26, label %bb27

for.body6:                                        ; preds = %bb26
  %i9 = load i32, i32* %ALPHA.addr, align 4
  %i10 = load i32, i32* %k, align 4
  %conv7 = sext i32 %i10 to i64
  %call8 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %A, i64 %conv7) #10
  ...
  %i12 = load i32, i32* %call10, align 4
  %mul = mul nsw i32 %i9, %i12
  %i13 = load i32, i32* %j, align 4
  %conv11 = sext i32 %i13 to i64
  ...
  %i15 = load i32, i32* %call14, align 4
  %mul15 = mul nsw i32 %mul, %i15
  %i16 = load i32, i32* %sum, align 4
  %add = add nsw i32 %i16, %mul15
  store i32 %add, i32* %sum, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body6
  %i17 = load i32, i32* %k, align 4
  %inc = add nsw i32 %i17, 1
  store i32 %inc, i32* %k, align 4
  br label %for.cond4

for.end:                                          ; preds = %bb27
  %i18 = load i32, i32* %sum, align 4
  %i19 = load i32, i32* %j, align 4
  %conv16 = sext i32 %i19 to i64
  ...
  %i20 = load i32, i32* %call17, align 4
  %add18 = add nsw i32 %i20, %i18
  store i32 %add18, i32* %call17, align 4
  br label %for.inc19

for.inc19:                                        ; preds = %for.end
  %i21 = load i32, i32* %j, align 4
  %inc20 = add nsw i32 %i21, 1
  store i32 %inc20, i32* %j, align 4
  br label %for.cond1

for.end21:                                        ; preds = %bb25
...
bb25:                                             ; preds = %for.cond1
  br label %for.end21

bb26:                                             ; preds = %for.cond4
  br label %for.body6

bb27:                                             ; preds = %for.cond4
  br label %for.end

bb28:                                             ; preds = %for.end26
  br label %nrvo.skipdtor

bb29:                                             ; preds = %for.end26
