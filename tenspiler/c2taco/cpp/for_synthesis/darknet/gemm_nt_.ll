; ModuleID = 'for_synthesis/darknet/gemm_nt_.ll'
source_filename = "for_synthesis/darknet/gemm_nt_.cc"
...
define dso_local void @_Z7gemm_ntiiiiNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_S5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %ALPHA, i32 %M, i32 %N, i32 %K, %"class.std::__1::vector"* %A, %"class.std::__1::vector"* %B, %"class.std::__1::vector"* %C) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  %i7 = load i32, i32* %K.addr, align 4
  %cmp5 = icmp slt i32 %i6, %i7
  br i1 %cmp5, label %bb26, label %bb27

for.body6:                                        ; preds = %bb26
  %i8 = load i32, i32* %ALPHA.addr, align 4
  %i9 = load i32, i32* %i, align 4
  %conv = sext i32 %i9 to i64
  ...
  %i11 = load i32, i32* %call8, align 4
  %mul = mul nsw i32 %i8, %i11
  %i12 = load i32, i32* %j, align 4
  %conv9 = sext i32 %i12 to i64
  ...
  %i14 = load i32, i32* %call12, align 4
  %mul13 = mul nsw i32 %mul, %i14
  %i15 = load i32, i32* %sum, align 4
  %add = add nsw i32 %i15, %mul13
  store i32 %add, i32* %sum, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body6
  %i16 = load i32, i32* %k, align 4
...
for.end:                                          ; preds = %bb27
  ...
  %conv14 = sext i32 %i17 to i64
  %call15 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %C, i64 %conv14) #10
  %i18 = load i32, i32* %j, align 4
  %conv16 = sext i32 %i18 to i64
  %call17 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call15, i64 %conv16) #10
  %i19 = load i32, i32* %call17, align 4
  %i20 = load i32, i32* %sum, align 4
  %add18 = add nsw i32 %i19, %i20
  store i32 %add18, i32* %ref.tmp, align 4
...
for.inc23:                                        ; preds = %invoke.cont22
  ...
  %inc24 = add nsw i32 %i22, 1
  store i32 %inc24, i32* %i, align 4
  br label %for.cond

for.end25:                                        ; preds = %bb23
