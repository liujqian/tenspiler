; ModuleID = 'for_synthesis/utdsp/histogram_.ll'
source_filename = "for_synthesis/utdsp/histogram_.cc"
...
define dso_local void @_Z9histogrami(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %N) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
