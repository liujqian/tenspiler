; ModuleID = 'for_synthesis/utdsp/dct_.ll'
source_filename = "for_synthesis/utdsp/dct_.cc"
...
define dso_local void @_Z3dctNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_S5_S5_ii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %A, %"class.std::__1::vector"* %B, %"class.std::__1::vector"* %C, %"class.std::__1::vector"* %D, i32 %M, i32 %N) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %result.ptr = alloca i8*, align 8
  %M.addr = alloca i32, align 4
  %N.addr = alloca i32, align 4
  %tempD = alloca %"class.std::__1::vector", align 8
  ...
  %row24 = alloca %"class.std::__1::vector.0", align 8
  %j25 = alloca i32, align 4
  %sum29 = alloca i32, align 4
  %k30 = alloca i32, align 4
  %i1 = bitcast %"class.std::__1::vector"* %agg.result to i8*
  store i8* %i1, i8** %result.ptr, align 8
  store i32 %M, i32* %M.addr, align 4
  store i32 %N, i32* %N.addr, align 4
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEC2Ev(%"class.std::__1::vector"* %tempD) #10
...
for.cond1:                                        ; preds = %for.inc13, %for.body
  ...
  br i1 %cmp2, label %bb36, label %bb37

for.body3:                                        ; preds = %bb36
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  br i1 %cmp5, label %bb38, label %bb39

for.body6:                                        ; preds = %bb38
  ...
  %call10 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %C, i64 %conv9) #10
...
for.end15:                                        ; preds = %bb37
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE9push_backERKS3_(%"class.std::__1::vector"* %tempD, %"class.std::__1::vector.0"* nonnull align 8 dereferenceable(24) %row)
...
for.cond21:                                       ; preds = %for.inc53, %for.end19
  %i18 = load i32, i32* %i20, align 4
  %i19 = load i32, i32* %M.addr, align 4
  %cmp22 = icmp slt i32 %i18, %i19
  br i1 %cmp22, label %bb40, label %bb41

for.body23:                                       ; preds = %bb40
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector.0"* %row24) #10
  store i32 0, i32* %j25, align 4
  br label %for.cond26

for.cond26:                                       ; preds = %for.inc49, %for.body23
  %i21 = load i32, i32* %j25, align 4
  %i22 = load i32, i32* %N.addr, align 4
  %cmp27 = icmp slt i32 %i21, %i22
  br i1 %cmp27, label %bb42, label %bb43

for.body28:                                       ; preds = %bb42
  store i32 0, i32* %sum29, align 4
  store i32 0, i32* %k30, align 4
  br label %for.cond31

for.cond31:                                       ; preds = %for.inc44, %for.body28
  %i23 = load i32, i32* %k30, align 4
  %i24 = load i32, i32* %N.addr, align 4
  %cmp32 = icmp slt i32 %i23, %i24
  br i1 %cmp32, label %bb44, label %bb45

for.body33:                                       ; preds = %bb44
  %i25 = load i32, i32* %i20, align 4
  %conv34 = sext i32 %i25 to i64
  %call35 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %B, i64 %conv34) #10
  %i26 = load i32, i32* %k30, align 4
  %conv36 = sext i32 %i26 to i64
  %call37 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call35, i64 %conv36) #10
  %i27 = load i32, i32* %call37, align 4
  %i28 = load i32, i32* %k30, align 4
  %conv38 = sext i32 %i28 to i64
  %call39 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %tempD, i64 %conv38) #10
  %i29 = load i32, i32* %j25, align 4
  %conv40 = sext i32 %i29 to i64
  %call41 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call39, i64 %conv40) #10
  %i30 = load i32, i32* %call41, align 4
  %mul42 = mul nsw i32 %i27, %i30
  %i31 = load i32, i32* %sum29, align 4
  %add43 = add nsw i32 %i31, %mul42
  store i32 %add43, i32* %sum29, align 4
  br label %for.inc44

for.inc44:                                        ; preds = %for.body33
  %i32 = load i32, i32* %k30, align 4
  %inc45 = add nsw i32 %i32, 1
  store i32 %inc45, i32* %k30, align 4
  br label %for.cond31

for.end46:                                        ; preds = %bb45
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %row24, i32* nonnull align 4 dereferenceable(4) %sum29)
...
for.inc49:                                        ; preds = %invoke.cont48
  %i33 = load i32, i32* %j25, align 4
  %inc50 = add nsw i32 %i33, 1
  store i32 %inc50, i32* %j25, align 4
  br label %for.cond26

for.end51:                                        ; preds = %bb43
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE9push_backERKS3_(%"class.std::__1::vector"* %agg.result, %"class.std::__1::vector.0"* nonnull align 8 dereferenceable(24) %row24)
  br label %invoke.cont52

invoke.cont52:                                    ; preds = %for.end51
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector.0"* %row24) #10
  br label %for.inc53

for.inc53:                                        ; preds = %invoke.cont52
  %i34 = load i32, i32* %i20, align 4
  %inc54 = add nsw i32 %i34, 1
  store i32 %inc54, i32* %i20, align 4
  br label %for.cond21

for.end55:                                        ; preds = %bb41
  store i1 true, i1* %nrvo, align 1
  %nrvo.val = load i1, i1* %nrvo, align 1
  br i1 %nrvo.val, label %bb46, label %bb47

nrvo.unused:                                      ; preds = %bb47
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEED2Ev(%"class.std::__1::vector"* %agg.result) #10
  br label %nrvo.skipdtor

nrvo.skipdtor:                                    ; preds = %bb46, %nrvo.unused
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEED2Ev(%"class.std::__1::vector"* %tempD) #10
  ret void
...
bb36:                                             ; preds = %for.cond1
  br label %for.body3

bb37:                                             ; preds = %for.cond1
  br label %for.end15

bb38:                                             ; preds = %for.cond4
  br label %for.body6

bb39:                                             ; preds = %for.cond4
  br label %for.end

bb40:                                             ; preds = %for.cond21
  br label %for.body23

bb41:                                             ; preds = %for.cond21
  br label %for.end55

bb42:                                             ; preds = %for.cond26
  br label %for.body28

bb43:                                             ; preds = %for.cond26
  br label %for.end51

bb44:                                             ; preds = %for.cond31
  br label %for.body33

bb45:                                             ; preds = %for.cond31
  br label %for.end46

bb46:                                             ; preds = %for.end55
  br label %nrvo.skipdtor

bb47:                                             ; preds = %for.end55
