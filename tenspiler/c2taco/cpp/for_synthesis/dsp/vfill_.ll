; ModuleID = './for_synthesis/dsp/vfill_.ll'
source_filename = "./for_synthesis/dsp/vfill_.cc"
...
define dso_local void @_Z5vfillNSt3__16vectorIiNS_9allocatorIiEEEEi(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %arr, i32 %v) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body:                                         ; preds = %bb
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector"* %agg.result, i32* nonnull align 4 dereferenceable(4) %v.addr)
