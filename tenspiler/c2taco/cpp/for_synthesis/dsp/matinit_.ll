; ModuleID = 'for_synthesis/dsp/matinit_.ll'
source_filename = "for_synthesis/dsp/matinit_.cc"
...
define dso_local void @_Z7matinitiii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %M, i32 %N, i32 %val) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  br i1 %cmp2, label %bb9, label %bb10

for.body3:                                        ; preds = %bb9
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %row, i32* nonnull align 4 dereferenceable(4) %val.addr)
...
for.inc5:                                         ; preds = %invoke.cont4
  %i7 = load i32, i32* %i, align 4
  %inc6 = add nsw i32 %i7, 1
