; ModuleID = 'for_synthesis/dspstone/matrix2_.ll'
source_filename = "for_synthesis/dspstone/matrix2_.cc"
...
define dso_local void @_Z7matrix2iiNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %M, i32 %N, %"class.std::__1::vector"* %A, %"class.std::__1::vector"* %B) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body3:                                        ; preds = %bb23
  ...
  %call4 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call, i64 0) #10
  %i7 = load i32, i32* %call4, align 4
  %i8 = load i32, i32* %i, align 4
  %conv5 = sext i32 %i8 to i64
  %call6 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %B, i64 %conv5) #10
  %call7 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call6, i64 0) #10
  %i9 = load i32, i32* %call7, align 4
...
for.cond8:                                        ; preds = %for.inc, %for.body3
  ...
  %i11 = load i32, i32* %N.addr, align 4
  %cmp9 = icmp slt i32 %i10, %i11
  br i1 %cmp9, label %bb25, label %bb26

for.body10:                                       ; preds = %bb25
  %i12 = load i32, i32* %j, align 4
  %conv11 = sext i32 %i12 to i64
  %call12 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %A, i64 %conv11) #10
  %i13 = load i32, i32* %k, align 4
  %conv13 = sext i32 %i13 to i64
  ...
  %i14 = load i32, i32* %call14, align 4
  %i15 = load i32, i32* %i, align 4
  %conv15 = sext i32 %i15 to i64
  %call16 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %B, i64 %conv15) #10
  %i16 = load i32, i32* %k, align 4
  %conv17 = sext i32 %i16 to i64
  %call18 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call16, i64 %conv17) #10
  %i17 = load i32, i32* %call18, align 4
  %mul19 = mul nsw i32 %i14, %i17
  %i18 = load i32, i32* %sum, align 4
  %add = add nsw i32 %i18, %mul19
  store i32 %add, i32* %sum, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body10
  %i19 = load i32, i32* %k, align 4
...
for.inc20:                                        ; preds = %invoke.cont
  %i20 = load i32, i32* %j, align 4
  %inc21 = add nsw i32 %i20, 1
  store i32 %inc21, i32* %j, align 4
  br label %for.cond1

for.end22:                                        ; preds = %bb24
...
for.inc24:                                        ; preds = %invoke.cont23
  ...
  %inc25 = add nsw i32 %i21, 1
  store i32 %inc25, i32* %i, align 4
  br label %for.cond

for.end26:                                        ; preds = %bb22
