; ModuleID = 'for_synthesis/dspstone/pin_down_.ll'
source_filename = "for_synthesis/dspstone/pin_down_.cc"
...
define dso_local void @_Z8pin_downi(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %N) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
