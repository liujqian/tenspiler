...
entry:
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector"* %agg.result) #11
...
for.body:                                         ; preds = %bb
  ...
  %call1 = call i32 @abs(i32 %i5) #12
  %i6 = load i32, i32* %s.addr, align 4
  %add = add nsw i32 %call1, %i6
...
nrvo.unused:                                      ; preds = %bb10
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector"* %agg.result) #11
...
define linkonce_odr hidden void @__clang_call_terminate(i8* %arg) #3 comdat {
bb:
...
invoke.cont:                                      ; preds = %entry
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE21_ConstructTransactionD2Ev(%"struct.std::__1::vector<int, std::__1::allocator<int>>::_ConstructTransaction"* %__tx) #11
  ret void
}
...
invoke.cont8:                                     ; preds = %invoke.cont
  call void @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEED2Ev(%"struct.std::__1::__split_buffer"* %__v) #11
  ret void
}
...
entry:
  ...
  %call = call noalias nonnull i8* @_Znwm(i64 %i) #16
  ret i8* %call
}
...
declare dso_local void @_ZNSt12length_errorD1Ev(%"class.std::length_error"*) unnamed_addr #7

declare dso_local void @__cxa_throw(i8*, i8*, i8*)

declare dso_local void @_ZNSt11logic_errorC2EPKc(%"class.std::logic_error"*, i8*) unnamed_addr #8
...
attributes #9 = { nobuiltin allocsize(0) "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
