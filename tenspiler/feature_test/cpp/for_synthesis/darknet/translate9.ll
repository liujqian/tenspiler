; ModuleID = './for_synthesis/darknet/translate9.ll'
source_filename = "./for_synthesis/darknet/translate9.cc"
...
define dso_local void @_Z10translate9NSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, i32 %n, i32 %s) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body3:                                        ; preds = %bb16
  ...
  %call5 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %a, i64 %conv4) #10
  %i11 = load i32, i32* %call5, align 4
  %i12 = load i32, i32* %s.addr, align 4
  %sub = sub nsw i32 %i11, %i12
  %i13 = load i32, i32* %i, align 4
  %conv6 = sext i32 %i13 to i64
  %call7 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %agg.result, i64 %conv6) #10
  store i32 %sub, i32* %call7, align 4
  br label %for.inc8

for.inc8:                                         ; preds = %for.body3
  %i14 = load i32, i32* %i, align 4
  %inc9 = add nsw i32 %i14, 1
  store i32 %inc9, i32* %i, align 4
  br label %for.cond1

for.end10:                                        ; preds = %bb17
...
bb18:                                             ; preds = %for.end10
  br label %nrvo.skipdtor

bb19:                                             ; preds = %for.end10
