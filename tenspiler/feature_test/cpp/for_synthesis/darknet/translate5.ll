; ModuleID = './for_synthesis/darknet/translate5.ll'
source_filename = "./for_synthesis/darknet/translate5.cc"
...
define dso_local void @_Z10translate5NSt3__16vectorIdNS_9allocatorIdEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, i32 %n, i32 %s) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body:                                         ; preds = %bb
  ...
  %call = call nonnull align 8 dereferenceable(8) double* @_ZNSt3__16vectorIdNS_9allocatorIdEEEixEm(%"class.std::__1::vector"* %a, i64 %conv) #10
  %i5 = load double, double* %call, align 8
  %i6 = load i32, i32* %s.addr, align 4
  %conv1 = sitofp i32 %i6 to double
  %add = fadd double %i5, %conv1
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 8 dereferenceable(8) double* @_ZNSt3__16vectorIdNS_9allocatorIdEEEixEm(%"class.std::__1::vector"* %this, i64 %__n) #1 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::vector"*, align 8
  ...
  %arrayidx = getelementptr inbounds double, double* %i1, i64 %i2
  ret double* %arrayidx
}
...
entry:
  ...
  store i8* null, i8** %ref.tmp, align 8
  %i1 = load %"class.std::__1::allocator"*, %"class.std::__1::allocator"** %__a.addr, align 8
  call void @_ZNSt3__117__compressed_pairIPdRNS_9allocatorIdEEEC2IDnS4_EEOT_OT0_(%"class.std::__1::__compressed_pair.1"* %__end_cap_, i8** nonnull align 8 dereferenceable(8) %ref.tmp, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %i1)
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt3__117__compressed_pairIPdRNS_9allocatorIdEEEC2IDnS4_EEOT_OT0_(%"class.std::__1::__compressed_pair.1"* %this, i8** nonnull align 8 dereferenceable(8) %__t1, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %__t2) unnamed_addr #0 comdat align 2 {
entry:
  ...
  call void @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIdEELi1ELb0EEC2IS3_vEEOT_(%"struct.std::__1::__compressed_pair_elem.2"* %i4, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %call2)
  ret void
}
...
entry:
  ...
  %this1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %this.addr, align 8
  %__end_cap_ = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %this1, i32 0, i32 3
  %call = call nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__117__compressed_pairIPdRNS_9allocatorIdEEE6secondEv(%"class.std::__1::__compressed_pair.1"* %__end_cap_) #10
  ret %"class.std::__1::allocator"* %call
}
...
entry:
  ...
  %this1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %this.addr, align 8
  %__end_cap_ = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %this1, i32 0, i32 3
  %call = call nonnull align 8 dereferenceable(8) double** @_ZNSt3__117__compressed_pairIPdRNS_9allocatorIdEEE5firstEv(%"class.std::__1::__compressed_pair.1"* %__end_cap_) #10
  ret double** %call
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIdEELi1ELb0EEC2IS3_vEEOT_(%"struct.std::__1::__compressed_pair_elem.2"* %this, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %__u) unnamed_addr #1 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__117__compressed_pairIPdRNS_9allocatorIdEEE6secondEv(%"class.std::__1::__compressed_pair.1"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::__compressed_pair.1"*, align 8
  store %"class.std::__1::__compressed_pair.1"* %this, %"class.std::__1::__compressed_pair.1"** %this.addr, align 8
  %this1 = load %"class.std::__1::__compressed_pair.1"*, %"class.std::__1::__compressed_pair.1"** %this.addr, align 8
  ...
  %call = call nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIdEELi1ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem.2"* %i1) #10
  ret %"class.std::__1::allocator"* %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIdEELi1ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem.2"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__1::__compressed_pair_elem.2"*, align 8
  store %"struct.std::__1::__compressed_pair_elem.2"* %this, %"struct.std::__1::__compressed_pair_elem.2"** %this.addr, align 8
  %this1 = load %"struct.std::__1::__compressed_pair_elem.2"*, %"struct.std::__1::__compressed_pair_elem.2"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 8 dereferenceable(8) double** @_ZNSt3__117__compressed_pairIPdRNS_9allocatorIdEEE5firstEv(%"class.std::__1::__compressed_pair.1"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::__compressed_pair.1"*, align 8
  store %"class.std::__1::__compressed_pair.1"* %this, %"class.std::__1::__compressed_pair.1"** %this.addr, align 8
  %this1 = load %"class.std::__1::__compressed_pair.1"*, %"class.std::__1::__compressed_pair.1"** %this.addr, align 8
...
entry:
  ...
  %this1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %this.addr, align 8
  %__end_cap_ = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %this1, i32 0, i32 3
  %call = call nonnull align 8 dereferenceable(8) double** @_ZNKSt3__117__compressed_pairIPdRNS_9allocatorIdEEE5firstEv(%"class.std::__1::__compressed_pair.1"* %__end_cap_) #10
  ret double** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 8 dereferenceable(8) double** @_ZNKSt3__117__compressed_pairIPdRNS_9allocatorIdEEE5firstEv(%"class.std::__1::__compressed_pair.1"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::__compressed_pair.1"*, align 8
  store %"class.std::__1::__compressed_pair.1"* %this, %"class.std::__1::__compressed_pair.1"** %this.addr, align 8
  %this1 = load %"class.std::__1::__compressed_pair.1"*, %"class.std::__1::__compressed_pair.1"** %this.addr, align 8
