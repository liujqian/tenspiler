; ModuleID = './for_synthesis/darknet/translate0.ll'
source_filename = "./for_synthesis/darknet/translate0.cc"
...
define dso_local void @_Z10translate0NSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, i32 %n, i32 %s) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
