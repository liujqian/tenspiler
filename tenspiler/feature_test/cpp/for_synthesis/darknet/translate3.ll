; ModuleID = './for_synthesis/darknet/translate3.ll'
source_filename = "./for_synthesis/darknet/translate3.cc"
...
define dso_local void @_Z10translate3NSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, i32 %n, i32 %s) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body3:                                        ; preds = %bb15
  ...
  %call6 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %a, i64 %conv5) #10
...
invoke.cont8:                                     ; preds = %for.body3
  br label %for.inc9

for.inc9:                                         ; preds = %invoke.cont8
  %i13 = load i32, i32* %i, align 4
  %inc10 = add nsw i32 %i13, 1
  store i32 %inc10, i32* %i, align 4
  br label %for.cond1

for.end11:                                        ; preds = %bb16
