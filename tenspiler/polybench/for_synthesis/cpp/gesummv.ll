; ModuleID = './tenspiler/c2taco/cpp/for_synthesis/polybench/gesummv.ll'
source_filename = "./tenspiler/c2taco/cpp/for_synthesis/polybench/gesummv.cc"
...
define dso_local void @_Z14kernel_gesummvNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_S3_ii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %A, %"class.std::__1::vector"* %B, %"class.std::__1::vector.0"* %x, i32 %alpha, i32 %beta) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %result.ptr = alloca i8*, align 8
  %alpha.addr = alloca i32, align 4
  %beta.addr = alloca i32, align 4
  %N = alloca i32, align 4
  %tmp_out = alloca %"class.std::__1::vector.0", align 8
  %y_out = alloca %"class.std::__1::vector.0", align 8
  ...
  %call = call i64 @_ZNKSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE4sizeEv(%"class.std::__1::vector"* %A) #10
  %conv = trunc i64 %call to i32
  store i32 %conv, i32* %N, align 4
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector.0"* %tmp_out) #10
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector.0"* %y_out) #10
  store i32 0, i32* %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc25, %entry
  %i2 = load i32, i32* %i, align 4
  %i3 = load i32, i32* %N, align 4
  %cmp = icmp slt i32 %i2, %i3
  br i1 %cmp, label %bb, label %bb23

for.body:                                         ; preds = %bb
  store i32 0, i32* %tmp_val, align 4
  store i32 0, i32* %y_val, align 4
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %call3 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %A, i64 0) #10
  %call4 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %call3) #10
  %cmp5 = icmp ult i64 %conv2, %call4
  br i1 %cmp5, label %bb24, label %bb25

for.body6:                                        ; preds = %bb24
  ...
  %call12 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %x, i64 %conv11) #10
  %i9 = load i32, i32* %call12, align 4
  %mul = mul nsw i32 %i7, %i9
  %i10 = load i32, i32* %tmp_val, align 4
  %add = add nsw i32 %mul, %i10
  store i32 %add, i32* %tmp_val, align 4
  %i11 = load i32, i32* %i, align 4
  %conv13 = sext i32 %i11 to i64
  %call14 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %B, i64 %conv13) #10
  %i12 = load i32, i32* %j, align 4
  %conv15 = sext i32 %i12 to i64
  ...
  %i13 = load i32, i32* %call16, align 4
  %i14 = load i32, i32* %j, align 4
  %conv17 = sext i32 %i14 to i64
  %call18 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %x, i64 %conv17) #10
  %i15 = load i32, i32* %call18, align 4
  %mul19 = mul nsw i32 %i13, %i15
  %i16 = load i32, i32* %y_val, align 4
  %add20 = add nsw i32 %mul19, %i16
  store i32 %add20, i32* %y_val, align 4
  br label %for.inc
...
for.end:                                          ; preds = %bb25
  %i18 = load i32, i32* %alpha.addr, align 4
  %i19 = load i32, i32* %tmp_val, align 4
  %mul21 = mul nsw i32 %i18, %i19
  %i20 = load i32, i32* %beta.addr, align 4
  %i21 = load i32, i32* %y_val, align 4
  %mul22 = mul nsw i32 %i20, %i21
  %add23 = add nsw i32 %mul21, %mul22
  store i32 %add23, i32* %y_val, align 4
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %tmp_out, i32* nonnull align 4 dereferenceable(4) %tmp_val)
  br label %invoke.cont

invoke.cont:                                      ; preds = %for.end
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %y_out, i32* nonnull align 4 dereferenceable(4) %y_val)
...
for.inc25:                                        ; preds = %invoke.cont24
  ...
  %inc26 = add nsw i32 %i22, 1
  store i32 %inc26, i32* %i, align 4
  br label %for.cond

for.end27:                                        ; preds = %bb23
  store i1 false, i1* %nrvo, align 1
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEC2Ev(%"class.std::__1::vector"* %agg.result) #10
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE9push_backERKS3_(%"class.std::__1::vector"* %agg.result, %"class.std::__1::vector.0"* nonnull align 8 dereferenceable(24) %tmp_out)
  br label %invoke.cont29

invoke.cont29:                                    ; preds = %for.end27
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE9push_backERKS3_(%"class.std::__1::vector"* %agg.result, %"class.std::__1::vector.0"* nonnull align 8 dereferenceable(24) %y_out)
  br label %invoke.cont30

invoke.cont30:                                    ; preds = %invoke.cont29
  store i1 true, i1* %nrvo, align 1
  %nrvo.val = load i1, i1* %nrvo, align 1
  br i1 %nrvo.val, label %bb26, label %bb27

nrvo.unused:                                      ; preds = %bb27
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEED2Ev(%"class.std::__1::vector"* %agg.result) #10
  br label %nrvo.skipdtor

nrvo.skipdtor:                                    ; preds = %bb26, %nrvo.unused
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector.0"* %y_out) #10
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector.0"* %tmp_out) #10
  ret void
...
bb26:                                             ; preds = %invoke.cont30
  br label %nrvo.skipdtor

bb27:                                             ; preds = %invoke.cont30
...
entry:
  ...
  store i8* null, i8** %ref.tmp, align 8
  %i1 = load %"class.std::__1::allocator"*, %"class.std::__1::allocator"** %__a.addr, align 8
  call void @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEEC2IDnS4_EEOT_OT0_(%"class.std::__1::__compressed_pair.8"* %__end_cap_, i8** nonnull align 8 dereferenceable(8) %ref.tmp, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %i1)
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEEC2IDnS4_EEOT_OT0_(%"class.std::__1::__compressed_pair.8"* %this, i8** nonnull align 8 dereferenceable(8) %__t1, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %__t2) unnamed_addr #0 comdat align 2 {
entry:
  ...
  call void @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIiEELi1ELb0EEC2IS3_vEEOT_(%"struct.std::__1::__compressed_pair_elem.9"* %i4, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %call2)
  ret void
}
...
entry:
  ...
  %this1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %this.addr, align 8
  %__end_cap_ = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %this1, i32 0, i32 3
  %call = call nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE6secondEv(%"class.std::__1::__compressed_pair.8"* %__end_cap_) #10
  ret %"class.std::__1::allocator"* %call
}
...
entry:
  ...
  %this1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %this.addr, align 8
  %__end_cap_ = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %this1, i32 0, i32 3
  %call = call nonnull align 8 dereferenceable(8) i32** @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.8"* %__end_cap_) #10
  ret i32** %call
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIiEELi1ELb0EEC2IS3_vEEOT_(%"struct.std::__1::__compressed_pair_elem.9"* %this, %"class.std::__1::allocator"* nonnull align 1 dereferenceable(1) %__u) unnamed_addr #1 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE6secondEv(%"class.std::__1::__compressed_pair.8"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::__compressed_pair.8"*, align 8
  store %"class.std::__1::__compressed_pair.8"* %this, %"class.std::__1::__compressed_pair.8"** %this.addr, align 8
  %this1 = load %"class.std::__1::__compressed_pair.8"*, %"class.std::__1::__compressed_pair.8"** %this.addr, align 8
  ...
  %call = call nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIiEELi1ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem.9"* %i1) #10
  ret %"class.std::__1::allocator"* %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 1 dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIiEELi1ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem.9"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__1::__compressed_pair_elem.9"*, align 8
  store %"struct.std::__1::__compressed_pair_elem.9"* %this, %"struct.std::__1::__compressed_pair_elem.9"** %this.addr, align 8
  %this1 = load %"struct.std::__1::__compressed_pair_elem.9"*, %"struct.std::__1::__compressed_pair_elem.9"** %this.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 8 dereferenceable(8) i32** @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.8"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::__compressed_pair.8"*, align 8
  store %"class.std::__1::__compressed_pair.8"* %this, %"class.std::__1::__compressed_pair.8"** %this.addr, align 8
  %this1 = load %"class.std::__1::__compressed_pair.8"*, %"class.std::__1::__compressed_pair.8"** %this.addr, align 8
...
entry:
  ...
  %this1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %this.addr, align 8
  %__end_cap_ = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %this1, i32 0, i32 3
  %call = call nonnull align 8 dereferenceable(8) i32** @_ZNKSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.8"* %__end_cap_) #10
  ret i32** %call
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 8 dereferenceable(8) i32** @_ZNKSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.8"* %this) #1 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::__compressed_pair.8"*, align 8
  store %"class.std::__1::__compressed_pair.8"* %this, %"class.std::__1::__compressed_pair.8"** %this.addr, align 8
  %this1 = load %"class.std::__1::__compressed_pair.8"*, %"class.std::__1::__compressed_pair.8"** %this.addr, align 8
...
entry:
  ...
  %__p.addr = alloca %"class.std::__1::vector.0"*, align 8
  %agg.tmp = alloca %"struct.std::__1::integral_constant", align 1
  %ref.tmp = alloca %"struct.std::__1::__has_destroy.11", align 1
  store %"class.std::__1::allocator.6"* %__a, %"class.std::__1::allocator.6"** %__a.addr, align 8
  store %"class.std::__1::vector.0"* %__p, %"class.std::__1::vector.0"** %__p.addr, align 8
  %i = bitcast %"struct.std::__1::__has_destroy.11"* %ref.tmp to %"struct.std::__1::integral_constant"*
...
entry:
  ...
  %undef.agg.tmp = alloca %"class.std::__1::allocator", align 1
  store %"class.std::__1::allocator"* %__a, %"class.std::__1::allocator"** %__a.addr, align 8
  %i = bitcast %"struct.std::__1::__has_select_on_container_copy_construction"* %ref.tmp to %"struct.std::__1::integral_constant.10"*
  %i1 = load %"class.std::__1::allocator"*, %"class.std::__1::allocator"** %__a.addr, align 8
