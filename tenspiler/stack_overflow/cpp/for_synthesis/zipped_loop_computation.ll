; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/zipped_loop_computation.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/zipped_loop_computation.cc"
...
define dso_local void @_Z23zipped_loop_computationNSt3__16vectorIiNS_9allocatorIiEEEES3_S3_S3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector.0"* %a, %"class.std::__1::vector.0"* %b, %"class.std::__1::vector.0"* %d, %"class.std::__1::vector.0"* %e) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond3:                                        ; preds = %for.inc, %for.body
  ...
  %i5 = load i32, i32* %m, align 4
  %cmp4 = icmp slt i32 %i4, %i5
  br i1 %cmp4, label %bb17, label %bb18

for.body5:                                        ; preds = %bb17
  %i6 = load i32, i32* %j, align 4
  %conv6 = sext i32 %i6 to i64
  %call7 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %b, i64 %conv6) #10
  %i7 = load i32, i32* %call7, align 4
  ...
  %i9 = load i32, i32* %call9, align 4
  %sub = sub nsw i32 25, %i9
  %mul = mul nsw i32 %i7, %sub
  %div = sdiv i32 %mul, 8
  %i10 = load i32, i32* %i, align 4
  %conv10 = sext i32 %i10 to i64
  %call11 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %e, i64 %conv10) #10
  %i11 = load i32, i32* %call11, align 4
  %mul12 = mul nsw i32 %div, %i11
  %i12 = load i32, i32* %i, align 4
  %conv13 = sext i32 %i12 to i64
  %call14 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %d, i64 %conv13) #10
  %i13 = load i32, i32* %call14, align 4
  %add = add nsw i32 %mul12, %i13
  store i32 %add, i32* %val, align 4
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %row_vec, i32* nonnull align 4 dereferenceable(4) %val)
...
bb17:                                             ; preds = %for.cond3
  br label %for.body5

bb18:                                             ; preds = %for.cond3
  br label %for.end

bb19:                                             ; preds = %for.end18
  br label %nrvo.skipdtor

bb20:                                             ; preds = %for.end18
