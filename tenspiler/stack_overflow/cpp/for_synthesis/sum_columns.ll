...
for.body:                                         ; preds = %bb
  %i4 = load i32, i32* %c.addr, align 4
  %call2 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector.1"* %a, i64 0) #10
  %i5 = load i32, i32* %i, align 4
  %conv3 = sext i32 %i5 to i64
  %call4 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %call2, i64 %conv3) #10
  %i6 = load i32, i32* %call4, align 4
  %call5 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector.1"* %a, i64 1) #10
  %i7 = load i32, i32* %i, align 4
  %conv6 = sext i32 %i7 to i64
  %call7 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %call5, i64 %conv6) #10
  %i8 = load i32, i32* %call7, align 4
  %mul = mul nsw i32 2, %i8
  %add = add nsw i32 %i6, %mul
  %call8 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector.1"* %a, i64 2) #10
  %i9 = load i32, i32* %i, align 4
  %conv9 = sext i32 %i9 to i64
  %call10 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %call8, i64 %conv9) #10
  %i10 = load i32, i32* %call10, align 4
  %mul11 = mul nsw i32 2, %i10
  %add12 = add nsw i32 %add, %mul11
  %call13 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector.1"* %a, i64 3) #10
  %i11 = load i32, i32* %i, align 4
  %conv14 = sext i32 %i11 to i64
  %call15 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %call13, i64 %conv14) #10
  %i12 = load i32, i32* %call15, align 4
  %add16 = add nsw i32 %add12, %i12
  %mul17 = mul nsw i32 %i4, %add16
  store i32 %mul17, i32* %ref.tmp, align 4
...
for.end:                                          ; preds = %bb14
  ...
  br i1 %nrvo.val, label %bb15, label %bb16

nrvo.unused:                                      ; preds = %bb16
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector"* %agg.result) #10
  br label %nrvo.skipdtor

nrvo.skipdtor:                                    ; preds = %bb15, %nrvo.unused
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr hidden nonnull align 8 dereferenceable(24) %"class.std::__1::vector"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector.1"* %this, i64 %__n) #1 comdat align 2 {
entry:
  ...
  %i1 = load %"class.std::__1::vector"*, %"class.std::__1::vector"** %__begin_, align 8
  %i2 = load i64, i64* %__n.addr, align 8
  %arrayidx = getelementptr inbounds %"class.std::__1::vector", %"class.std::__1::vector"* %i1, i64 %i2
