; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/supply_demand.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/supply_demand.cc"
...
define dso_local void @_Z12supply_demanNSt3__16vectorIiNS_9allocatorIiEEEE(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %prices) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond:                                         ; preds = %for.inc9, %entry
  %i1 = load i32, i32* %m, align 4
  %i2 = load i32, i32* %n, align 4
...
for.cond1:                                        ; preds = %for.inc, %for.body
  %i3 = load i32, i32* %p, align 4
  %i4 = load i32, i32* %n, align 4
  %cmp2 = icmp slt i32 %i3, %i4
  br i1 %cmp2, label %bb13, label %bb14

for.body3:                                        ; preds = %bb13
  %i5 = load i32, i32* %p, align 4
  %conv4 = sext i32 %i5 to i64
  %call5 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %prices, i64 %conv4) #10
  %i6 = load i32, i32* %call5, align 4
  %i7 = load i32, i32* %m, align 4
  %conv6 = sext i32 %i7 to i64
  %call7 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %prices, i64 %conv6) #10
  %i8 = load i32, i32* %call7, align 4
  %cmp8 = icmp sgt i32 %i6, %i8
  br i1 %cmp8, label %bb15, label %bb16

if.then:                                          ; preds = %bb15
  %i9 = load i32, i32* %count, align 4
  %add = add nsw i32 %i9, 1
  store i32 %add, i32* %count, align 4
  br label %if.end

if.end:                                           ; preds = %bb16, %if.then
  br label %for.inc

for.inc:                                          ; preds = %if.end
  %i10 = load i32, i32* %p, align 4
  %inc = add nsw i32 %i10, 1
  store i32 %inc, i32* %p, align 4
  br label %for.cond1

for.end:                                          ; preds = %bb14
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector"* %agg.result, i32* nonnull align 4 dereferenceable(4) %count)
  br label %invoke.cont

invoke.cont:                                      ; preds = %for.end
  br label %for.inc9

for.inc9:                                         ; preds = %invoke.cont
  %i11 = load i32, i32* %m, align 4
  %inc10 = add nsw i32 %i11, 1
  store i32 %inc10, i32* %m, align 4
  br label %for.cond

for.end11:                                        ; preds = %bb12
...
bb13:                                             ; preds = %for.cond1
  br label %for.body3

bb14:                                             ; preds = %for.cond1
  br label %for.end

bb15:                                             ; preds = %for.body3
  br label %if.then

bb16:                                             ; preds = %for.body3
  br label %if.end

bb17:                                             ; preds = %for.end11
  br label %nrvo.skipdtor

bb18:                                             ; preds = %for.end11
