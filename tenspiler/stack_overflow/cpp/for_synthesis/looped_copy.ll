; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/looped_copy.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/looped_copy.cc"
...
define dso_local void @_Z11looped_copyNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %u_50, %"class.std::__1::vector"* %u) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
bb11:                                             ; preds = %for.end14
  br label %nrvo.skipdtor

bb12:                                             ; preds = %for.end14
