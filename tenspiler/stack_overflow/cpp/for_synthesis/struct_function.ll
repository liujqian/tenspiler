; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/struct_function.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/struct_function.cc"
...
define dso_local void @_Z15structFunPythonNSt3__16vectorIiNS_9allocatorIiEEEES3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %f, %"class.std::__1::vector"* %sf2) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond:                                         ; preds = %for.inc20, %entry
  ...
  %call = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %sf2) #10
...
for.body:                                         ; preds = %bb
  ...
  %call2 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %sf2, i64 %conv1) #10
  %i4 = load i32, i32* %call2, align 4
  store i32 %i4, i32* %sf2_val, align 4
...
for.cond3:                                        ; preds = %for.inc, %for.body
  ...
  %call5 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %f) #10
  %cmp6 = icmp ult i64 %conv4, %call5
  br i1 %cmp6, label %bb23, label %bb24

for.body7:                                        ; preds = %bb23
  %i6 = load i32, i32* %j, align 4
  %cmp8 = icmp sge i32 %i6, 1
  br i1 %cmp8, label %bb25, label %bb26

land.lhs.true:                                    ; preds = %bb25
  %i7 = load i32, i32* %j, align 4
  %conv9 = sext i32 %i7 to i64
  %call10 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %f) #10
  %i8 = load i32, i32* %i, align 4
  %conv11 = sext i32 %i8 to i64
  %sub = sub i64 %call10, %conv11
  %cmp12 = icmp ult i64 %conv9, %sub
  br i1 %cmp12, label %bb27, label %bb28

if.then:                                          ; preds = %bb27
  %i9 = load i32, i32* %i, align 4
  %i10 = load i32, i32* %j, align 4
  %add = add nsw i32 %i9, %i10
  %conv13 = sext i32 %add to i64
  %call14 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %f, i64 %conv13) #10
  %i11 = load i32, i32* %call14, align 4
  %i12 = load i32, i32* %i, align 4
  %conv15 = sext i32 %i12 to i64
  %call16 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %f, i64 %conv15) #10
  %i13 = load i32, i32* %call16, align 4
  %sub17 = sub nsw i32 %i11, %i13
  store i32 %sub17, i32* %diff, align 4
  %i14 = load i32, i32* %sf2_val, align 4
  %i15 = load i32, i32* %diff, align 4
  %i16 = load i32, i32* %diff, align 4
  %mul = mul nsw i32 %i15, %i16
  %add18 = add nsw i32 %i14, %mul
  store i32 %add18, i32* %sf2_val, align 4
  %i17 = load i32, i32* %count, align 4
  %add19 = add nsw i32 %i17, 1
  store i32 %add19, i32* %count, align 4
  br label %if.end

if.end:                                           ; preds = %bb28, %bb26, %if.then
  br label %for.inc

for.inc:                                          ; preds = %if.end
  %i18 = load i32, i32* %j, align 4
  %inc = add nsw i32 %i18, 1
  store i32 %inc, i32* %j, align 4
  br label %for.cond3

for.end:                                          ; preds = %bb24
  %i19 = load i32, i32* %sf2_val, align 4
  %i20 = load i32, i32* %count, align 4
  %div = sdiv i32 %i19, %i20
...
bb23:                                             ; preds = %for.cond3
  br label %for.body7

bb24:                                             ; preds = %for.cond3
  br label %for.end

bb25:                                             ; preds = %for.body7
  br label %land.lhs.true

bb26:                                             ; preds = %for.body7
  br label %if.end

bb27:                                             ; preds = %land.lhs.true
  br label %if.then

bb28:                                             ; preds = %land.lhs.true
  br label %if.end

bb29:                                             ; preds = %for.end22
  br label %nrvo.skipdtor

bb30:                                             ; preds = %for.end22
