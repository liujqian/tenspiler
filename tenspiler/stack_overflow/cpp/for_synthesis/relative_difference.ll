; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/relative_difference.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/relative_difference.cc"
...
define dso_local void @_Z29calculate_relative_differenceNSt3__16vectorIiNS_9allocatorIiEEEE(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector.0"* %a) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body3:                                        ; preds = %bb15
  ...
  %conv4 = sext i32 %i6 to i64
  %call5 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %a, i64 %conv4) #10
  %i7 = load i32, i32* %call5, align 4
  %i8 = load i32, i32* %i, align 4
  %conv6 = sext i32 %i8 to i64
  %call7 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %a, i64 %conv6) #10
  %i9 = load i32, i32* %call7, align 4
  %sub = sub nsw i32 %i7, %i9
  %i10 = load i32, i32* %i, align 4
  %conv8 = sext i32 %i10 to i64
  %call9 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %a, i64 %conv8) #10
  %i11 = load i32, i32* %call9, align 4
  %div = sdiv i32 %sub, %i11
...
bb17:                                             ; preds = %for.end13
  br label %nrvo.skipdtor

bb18:                                             ; preds = %for.end13
