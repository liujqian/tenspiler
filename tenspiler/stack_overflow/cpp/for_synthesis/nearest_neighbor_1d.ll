; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/nearest_neighbor_1d.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/nearest_neighbor_1d.cc"
...
%"struct.std::__1::__has_construct.18" = type { i8 }
...
define dso_local void @_Z13find_nnearestNSt3__16vectorIiNS_9allocatorIiEEEES3_S3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector.0"* %arr, %"class.std::__1::vector.0"* %val, %"class.std::__1::vector.0"* %N) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  %dist = alloca %"class.std::__1::vector.0", align 8
  %j = alloca i32, align 4
  %d = alloca i32, align 4
  %order = alloca %"class.std::__1::vector.0", align 8
  ...
  %idx = alloca %"class.std::__1::vector.0", align 8
...
for.cond:                                         ; preds = %for.inc7, %entry
  %i2 = load i32, i32* %r, align 4
  %conv = sext i32 %i2 to i64
  %call = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %N) #10
  %cmp = icmp ult i64 %conv, %call
  br i1 %cmp, label %bb, label %bb46
...
for.cond1:                                        ; preds = %for.inc, %for.body
  %i3 = load i32, i32* %c, align 4
  %conv2 = sext i32 %i3 to i64
  %call3 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %val) #10
  %cmp4 = icmp ult i64 %conv2, %call3
  br i1 %cmp4, label %bb47, label %bb48

for.body5:                                        ; preds = %bb47
...
for.inc7:                                         ; preds = %invoke.cont6
  %i5 = load i32, i32* %r, align 4
  %inc8 = add nsw i32 %i5, 1
...
for.cond10:                                       ; preds = %for.inc108, %for.end9
  %i6 = load i32, i32* %i, align 4
  %conv11 = sext i32 %i6 to i64
  %call12 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %val) #10
  %cmp13 = icmp ult i64 %conv11, %call12
  br i1 %cmp13, label %bb49, label %bb50

for.body14:                                       ; preds = %bb49
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector.0"* %dist) #10
  store i32 0, i32* %j, align 4
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc28, %for.body14
  %i7 = load i32, i32* %j, align 4
  %conv16 = sext i32 %i7 to i64
  %call17 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %arr) #10
  %cmp18 = icmp ult i64 %conv16, %call17
  br i1 %cmp18, label %bb51, label %bb52

for.body19:                                       ; preds = %bb51
  %i8 = load i32, i32* %j, align 4
  %conv20 = sext i32 %i8 to i64
  %call21 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %arr, i64 %conv20) #10
  %i9 = load i32, i32* %call21, align 4
  %i10 = load i32, i32* %i, align 4
  %conv22 = sext i32 %i10 to i64
  %call23 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %val, i64 %conv22) #10
  %i11 = load i32, i32* %call23, align 4
  %sub = sub nsw i32 %i9, %i11
  store i32 %sub, i32* %d, align 4
  %i12 = load i32, i32* %d, align 4
  %cmp24 = icmp slt i32 %i12, 0
  br i1 %cmp24, label %bb53, label %bb54

if.then:                                          ; preds = %bb53
  %i13 = load i32, i32* %d, align 4
  %sub25 = sub nsw i32 0, %i13
  store i32 %sub25, i32* %d, align 4
  br label %if.end

if.end:                                           ; preds = %bb54, %if.then
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %dist, i32* nonnull align 4 dereferenceable(4) %d)
...
for.inc28:                                        ; preds = %invoke.cont27
  ...
  %inc29 = add nsw i32 %i14, 1
  store i32 %inc29, i32* %j, align 4
  br label %for.cond15

for.end30:                                        ; preds = %bb52
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector.0"* %order) #10
  store i32 0, i32* %j31, align 4
  br label %for.cond32

for.cond32:                                       ; preds = %for.inc39, %for.end30
  %i15 = load i32, i32* %j31, align 4
  %conv33 = sext i32 %i15 to i64
  %call34 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %arr) #10
  %cmp35 = icmp ult i64 %conv33, %call34
  br i1 %cmp35, label %bb55, label %bb56

for.body36:                                       ; preds = %bb55
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %order, i32* nonnull align 4 dereferenceable(4) %j31)
...
for.inc39:                                        ; preds = %invoke.cont38
  %i16 = load i32, i32* %j31, align 4
  %inc40 = add nsw i32 %i16, 1
  store i32 %inc40, i32* %j31, align 4
  br label %for.cond32

for.end41:                                        ; preds = %bb56
  store i32 0, i32* %a, align 4
  br label %for.cond42

for.cond42:                                       ; preds = %for.inc77, %for.end41
  %i17 = load i32, i32* %a, align 4
  %conv43 = sext i32 %i17 to i64
  %call44 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %order) #10
  %cmp45 = icmp ult i64 %conv43, %call44
  br i1 %cmp45, label %bb57, label %bb58

for.body46:                                       ; preds = %bb57
  store i32 0, i32* %b, align 4
  br label %for.cond47

for.cond47:                                       ; preds = %for.inc74, %for.body46
  %i18 = load i32, i32* %b, align 4
  %add = add nsw i32 %i18, 1
  %conv48 = sext i32 %add to i64
  %call49 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %order) #10
  %cmp50 = icmp ult i64 %conv48, %call49
  br i1 %cmp50, label %bb59, label %bb60

for.body51:                                       ; preds = %bb59
  %i19 = load i32, i32* %b, align 4
  %conv52 = sext i32 %i19 to i64
  %call53 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %order, i64 %conv52) #10
  %i20 = load i32, i32* %call53, align 4
  store i32 %i20, i32* %ib, align 4
  %i21 = load i32, i32* %b, align 4
  %add54 = add nsw i32 %i21, 1
  %conv55 = sext i32 %add54 to i64
  %call56 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %order, i64 %conv55) #10
  %i22 = load i32, i32* %call56, align 4
  store i32 %i22, i32* %in, align 4
  %i23 = load i32, i32* %ib, align 4
  %conv57 = sext i32 %i23 to i64
  %call58 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %dist, i64 %conv57) #10
  %i24 = load i32, i32* %call58, align 4
  %i25 = load i32, i32* %in, align 4
  %conv59 = sext i32 %i25 to i64
  %call60 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %dist, i64 %conv59) #10
  %i26 = load i32, i32* %call60, align 4
  %cmp61 = icmp sgt i32 %i24, %i26
  br i1 %cmp61, label %bb61, label %bb62

if.then62:                                        ; preds = %bb61
  %i27 = load i32, i32* %b, align 4
  %conv63 = sext i32 %i27 to i64
  %call64 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %order, i64 %conv63) #10
  %i28 = load i32, i32* %call64, align 4
  store i32 %i28, i32* %tmp, align 4
  %i29 = load i32, i32* %b, align 4
  %add65 = add nsw i32 %i29, 1
  %conv66 = sext i32 %add65 to i64
  %call67 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %order, i64 %conv66) #10
  %i30 = load i32, i32* %call67, align 4
  %i31 = load i32, i32* %b, align 4
  %conv68 = sext i32 %i31 to i64
  %call69 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %order, i64 %conv68) #10
  store i32 %i30, i32* %call69, align 4
  %i32 = load i32, i32* %tmp, align 4
  %i33 = load i32, i32* %b, align 4
  %add70 = add nsw i32 %i33, 1
  %conv71 = sext i32 %add70 to i64
  %call72 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %order, i64 %conv71) #10
  store i32 %i32, i32* %call72, align 4
  br label %if.end73

if.end73:                                         ; preds = %bb62, %if.then62
  br label %for.inc74

for.inc74:                                        ; preds = %if.end73
  %i34 = load i32, i32* %b, align 4
  %inc75 = add nsw i32 %i34, 1
  store i32 %inc75, i32* %b, align 4
  br label %for.cond47

for.end76:                                        ; preds = %bb60
  br label %for.inc77

for.inc77:                                        ; preds = %for.end76
  %i35 = load i32, i32* %a, align 4
  %inc78 = add nsw i32 %i35, 1
  store i32 %inc78, i32* %a, align 4
  br label %for.cond42

for.end79:                                        ; preds = %bb58
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector.0"* %idx) #10
  store i32 0, i32* %k, align 4
  br label %for.cond80

for.cond80:                                       ; preds = %for.inc89, %for.end79
  %i36 = load i32, i32* %k, align 4
  %conv81 = sext i32 %i36 to i64
  %call82 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %N) #10
  %cmp83 = icmp ult i64 %conv81, %call82
  br i1 %cmp83, label %bb63, label %bb64

for.body84:                                       ; preds = %bb63
  %i37 = load i32, i32* %k, align 4
  %conv85 = sext i32 %i37 to i64
  %call86 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %order, i64 %conv85) #10
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %idx, i32* nonnull align 4 dereferenceable(4) %call86)
...
for.inc89:                                        ; preds = %invoke.cont88
  %i38 = load i32, i32* %k, align 4
  %inc90 = add nsw i32 %i38, 1
  store i32 %inc90, i32* %k, align 4
  br label %for.cond80

for.end91:                                        ; preds = %bb64
  store i32 0, i32* %r92, align 4
  br label %for.cond93

for.cond93:                                       ; preds = %for.inc104, %for.end91
  %i39 = load i32, i32* %r92, align 4
  %conv94 = sext i32 %i39 to i64
  %call95 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %N) #10
  %cmp96 = icmp ult i64 %conv94, %call95
  br i1 %cmp96, label %bb65, label %bb66

for.body97:                                       ; preds = %bb65
  %i40 = load i32, i32* %r92, align 4
  %conv98 = sext i32 %i40 to i64
  %call99 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %idx, i64 %conv98) #10
  %i41 = load i32, i32* %call99, align 4
  %i42 = load i32, i32* %r92, align 4
  %conv100 = sext i32 %i42 to i64
  %call101 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %agg.result, i64 %conv100) #10
  %i43 = load i32, i32* %i, align 4
  %conv102 = sext i32 %i43 to i64
  %call103 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call101, i64 %conv102) #10
  store i32 %i41, i32* %call103, align 4
  br label %for.inc104

for.inc104:                                       ; preds = %for.body97
  %i44 = load i32, i32* %r92, align 4
  %inc105 = add nsw i32 %i44, 1
  store i32 %inc105, i32* %r92, align 4
  br label %for.cond93

for.end106:                                       ; preds = %bb66
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector.0"* %idx) #10
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector.0"* %order) #10
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector.0"* %dist) #10
  br label %for.inc108

for.inc108:                                       ; preds = %for.end106
  %i45 = load i32, i32* %i, align 4
  %inc109 = add nsw i32 %i45, 1
  store i32 %inc109, i32* %i, align 4
  br label %for.cond10

for.end110:                                       ; preds = %bb50
  store i1 true, i1* %nrvo, align 1
  %nrvo.val = load i1, i1* %nrvo, align 1
  br i1 %nrvo.val, label %bb67, label %bb68

nrvo.unused:                                      ; preds = %bb68
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEED2Ev(%"class.std::__1::vector"* %agg.result) #10
  br label %nrvo.skipdtor

nrvo.skipdtor:                                    ; preds = %bb67, %nrvo.unused
  ret void
...
bb47:                                             ; preds = %for.cond1
  br label %for.body5

bb48:                                             ; preds = %for.cond1
  br label %for.end

bb49:                                             ; preds = %for.cond10
  br label %for.body14

bb50:                                             ; preds = %for.cond10
  br label %for.end110

bb51:                                             ; preds = %for.cond15
  br label %for.body19

bb52:                                             ; preds = %for.cond15
  br label %for.end30

bb53:                                             ; preds = %for.body19
  br label %if.then

bb54:                                             ; preds = %for.body19
  br label %if.end

bb55:                                             ; preds = %for.cond32
  br label %for.body36

bb56:                                             ; preds = %for.cond32
  br label %for.end41

bb57:                                             ; preds = %for.cond42
  br label %for.body46

bb58:                                             ; preds = %for.cond42
  br label %for.end79

bb59:                                             ; preds = %for.cond47
  br label %for.body51

bb60:                                             ; preds = %for.cond47
  br label %for.end76

bb61:                                             ; preds = %for.body51
  br label %if.then62

bb62:                                             ; preds = %for.body51
  br label %if.end73

bb63:                                             ; preds = %for.cond80
  br label %for.body84

bb64:                                             ; preds = %for.cond80
  br label %for.end91

bb65:                                             ; preds = %for.cond93
  br label %for.body97

bb66:                                             ; preds = %for.cond93
  br label %for.end106

bb67:                                             ; preds = %for.end110
  br label %nrvo.skipdtor

bb68:                                             ; preds = %for.end110
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr hidden void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backEOi(%"class.std::__1::vector.0"* %this, i32* nonnull align 4 dereferenceable(4) %__x) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::__1::vector.0"*, align 8
...
if.then:                                          ; preds = %bb
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE22__construct_one_at_endIJiEEEvDpOT_(%"class.std::__1::vector.0"* %this1, i32* nonnull align 4 dereferenceable(4) %call2)
  br label %if.end
...
if.else:                                          ; preds = %bb6
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE21__push_back_slow_pathIiEEvOT_(%"class.std::__1::vector.0"* %this1, i32* nonnull align 4 dereferenceable(4) %call3)
  br label %if.end
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt3__16vectorIiNS_9allocatorIiEEE22__construct_one_at_endIJiEEEvDpOT_(%"class.std::__1::vector.0"* %this, i32* nonnull align 4 dereferenceable(4) %__args) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__1::vector.0"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt3__16vectorIiNS_9allocatorIiEEE21__push_back_slow_pathIiEEvOT_(%"class.std::__1::vector.0"* %this, i32* nonnull align 4 dereferenceable(4) %__x) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__1::vector.0"*, align 8
  %__x.addr = alloca i32*, align 8
...
entry:
  ...
  %__args.addr = alloca i32*, align 8
  %agg.tmp = alloca %"struct.std::__1::integral_constant", align 1
  %ref.tmp = alloca %"struct.std::__1::__has_construct.18", align 1
  store %"class.std::__1::allocator"* %__a, %"class.std::__1::allocator"** %__a.addr, align 8
  store i32* %__p, i32** %__p.addr, align 8
  store i32* %__args, i32** %__args.addr, align 8
  %i = bitcast %"struct.std::__1::__has_construct.18"* %ref.tmp to %"struct.std::__1::integral_constant"*
  %i1 = load %"class.std::__1::allocator"*, %"class.std::__1::allocator"** %__a.addr, align 8
  %i2 = load i32*, i32** %__p.addr, align 8
  %i3 = load i32*, i32** %__args.addr, align 8
