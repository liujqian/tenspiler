; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/square_plus_one.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/square_plus_one.cc"
...
define dso_local void @_Z15square_plus_oneNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEE(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %arr_in) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
bb14:                                             ; preds = %for.cond4
  br label %for.body6

bb15:                                             ; preds = %for.cond4
  br label %for.end

bb16:                                             ; preds = %for.end14
  br label %nrvo.skipdtor

bb17:                                             ; preds = %for.end14
