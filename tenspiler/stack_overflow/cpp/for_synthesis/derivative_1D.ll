; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/derivative_1D.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/derivative_1D.cc"
...
define dso_local void @_Z13derivative_1DNSt3__16vectorIiNS_9allocatorIiEEEE(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector.0"* %x) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond:                                         ; preds = %for.inc10, %entry
  %i2 = load i32, i32* %mu, align 4
  %conv = sext i32 %i2 to i64
  %call = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %x) #10
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %call3 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %x) #10
  %cmp4 = icmp ult i64 %conv2, %call3
  br i1 %cmp4, label %bb11, label %bb12

for.body5:                                        ; preds = %bb11
  store i32 0, i32* %val, align 4
  %i4 = load i32, i32* %mu, align 4
  %i5 = load i32, i32* %i, align 4
  %cmp6 = icmp eq i32 %i4, %i5
  br i1 %cmp6, label %bb13, label %bb14

if.then:                                          ; preds = %bb13
  %i6 = load i32, i32* %i, align 4
  %conv7 = sext i32 %i6 to i64
  %call8 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %x, i64 %conv7) #10
  %i7 = load i32, i32* %call8, align 4
  %mul = mul nsw i32 2, %i7
...
for.inc10:                                        ; preds = %invoke.cont9
  %i9 = load i32, i32* %mu, align 4
  %inc11 = add nsw i32 %i9, 1
  store i32 %inc11, i32* %mu, align 4
  br label %for.cond

for.end12:                                        ; preds = %bb10
...
bb12:                                             ; preds = %for.cond1
  br label %for.end

bb13:                                             ; preds = %for.body5
  br label %if.then

bb14:                                             ; preds = %for.body5
  br label %if.end

bb15:                                             ; preds = %for.end12
  br label %nrvo.skipdtor

bb16:                                             ; preds = %for.end12
