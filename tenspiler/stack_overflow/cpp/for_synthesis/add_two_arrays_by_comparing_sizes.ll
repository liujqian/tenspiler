; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/add_two_arrays_by_comparing_sizes.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/add_two_arrays_by_comparing_sizes.cc"
...
define dso_local void @_Z33add_two_arrays_by_comparing_sizesNSt3__16vectorIiNS_9allocatorIiEEEES3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, %"class.std::__1::vector"* %b) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %a) #10
  %cmp = icmp ult i64 %conv, %call
  br i1 %cmp, label %bb, label %bb13

for.body:                                         ; preds = %bb
  store i32 0, i32* %current_val, align 4
  %i3 = load i32, i32* %i, align 4
  %conv1 = sext i32 %i3 to i64
  %call2 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %b, i64 %conv1) #10
  %i4 = load i32, i32* %call2, align 4
  %i5 = load i32, i32* %i, align 4
  %conv3 = sext i32 %i5 to i64
  %call4 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %a, i64 %conv3) #10
  %i6 = load i32, i32* %call4, align 4
  %cmp5 = icmp sge i32 %i4, %i6
  br i1 %cmp5, label %bb14, label %bb15

if.then:                                          ; preds = %bb14
  %i7 = load i32, i32* %i, align 4
  %conv6 = sext i32 %i7 to i64
  %call7 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %a, i64 %conv6) #10
  %i8 = load i32, i32* %call7, align 4
  %i9 = load i32, i32* %i, align 4
  %conv8 = sext i32 %i9 to i64
  %call9 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %b, i64 %conv8) #10
  %i10 = load i32, i32* %call9, align 4
  %add = add nsw i32 %i8, %i10
  store i32 %add, i32* %combined_result, align 4
  %i11 = load i32, i32* %combined_result, align 4
  store i32 %i11, i32* %current_val, align 4
  br label %if.end

if.end:                                           ; preds = %bb15, %if.then
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector"* %agg.result, i32* nonnull align 4 dereferenceable(4) %current_val)
