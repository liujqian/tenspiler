; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/set_one_in_columns.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/set_one_in_columns.cc"
...
define dso_local void @_Z18set_one_in_columnsNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %x, %"class.std::__1::vector.0"* %y) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body:                                         ; preds = %bb
  ...
  %call5 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %y, i64 %conv4) #10
  %i5 = load i32, i32* %call5, align 4
  store i32 %i5, i32* %num, align 4
  store i32 0, i32* %j, align 4
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc, %for.body
  %i6 = load i32, i32* %j, align 4
  %i7 = load i32, i32* %n, align 4
  %cmp7 = icmp slt i32 %i6, %i7
  br i1 %cmp7, label %bb13, label %bb14

for.body8:                                        ; preds = %bb13
  %i8 = load i32, i32* %j, align 4
  %i9 = load i32, i32* %num, align 4
  %cmp9 = icmp sge i32 %i8, %i9
  br i1 %cmp9, label %bb15, label %bb16
...
if.else:                                          ; preds = %bb16
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backEOi(%"class.std::__1::vector.0"* %row_vec, i32* nonnull align 4 dereferenceable(4) %ref.tmp10)
...
for.inc13:                                        ; preds = %invoke.cont12
  ...
  %inc14 = add nsw i32 %i11, 1
  store i32 %inc14, i32* %i, align 4
  br label %for.cond

for.end15:                                        ; preds = %bb12
...
bb13:                                             ; preds = %for.cond6
  br label %for.body8

bb14:                                             ; preds = %for.cond6
  br label %for.end

bb15:                                             ; preds = %for.body8
  br label %if.then

bb16:                                             ; preds = %for.body8
  br label %if.else

bb17:                                             ; preds = %for.end15
  br label %nrvo.skipdtor

bb18:                                             ; preds = %for.end15
