; ModuleID = '/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/mask_generation.ll'
source_filename = "/code/tenspiler/tenspiler/c2taco/cpp/for_synthesis/stackoverflow/mask_generation.cc"
...
define dso_local void @_Z15mask_generationNSt3__16vectorIiNS_9allocatorIiEEEE(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector.0"* %V) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond:                                         ; preds = %for.inc10, %entry
  ...
  %call = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %V) #10
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %i3, 20
  br i1 %cmp2, label %bb10, label %bb11

for.body3:                                        ; preds = %bb10
  %i4 = load i32, i32* %j, align 4
  %i5 = load i32, i32* %i, align 4
  %conv4 = sext i32 %i5 to i64
  %call5 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %V, i64 %conv4) #10
  %i6 = load i32, i32* %call5, align 4
  %cmp6 = icmp slt i32 %i4, %i6
  br i1 %cmp6, label %bb12, label %bb13
...
if.else:                                          ; preds = %bb13
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backEOi(%"class.std::__1::vector.0"* %row_vec, i32* nonnull align 4 dereferenceable(4) %ref.tmp7)
...
bb10:                                             ; preds = %for.cond1
  br label %for.body3

bb11:                                             ; preds = %for.cond1
  br label %for.end

bb12:                                             ; preds = %for.body3
  br label %if.then

bb13:                                             ; preds = %for.body3
  br label %if.else

bb14:                                             ; preds = %for.end12
  br label %nrvo.skipdtor

bb15:                                             ; preds = %for.end12
